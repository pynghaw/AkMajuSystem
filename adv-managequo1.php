                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="invoice-upfront1.php?q_no=<?php echo $row['q_no']; ?>" class="btn btn-success btn-sm padd">Generate Invoice</a> &nbsp;
                                                        <a href="adv-deletequo1.php?q_no=<?php echo $row['q_no']; ?>" onclick="return confirmDelete();" class="btn btn-danger btn-sm padd">Delete</a>
                                                    <?php
                                                    } elseif ($row['q_status'] == 1) {
                                                        // Confirmed Quotation Operations
                                                    ?>
                                                        <a href="adv-reviewquo1.php?q_no=<?php echo $row['q_no']; ?>" class="btn btn-secondary">Review</a> &nbsp;
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
