...
<form method="POST" action="const-generatequoprocess1.php">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button onclick="window.location.href='const-generatequoprocess1.php'" type="submit" class="btn mb-1 btn-flat btn-primary">Generate Quotation</button>
