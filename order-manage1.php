                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td style="text-align: center;">
                                                        <a href="order-modify1.php?o_no=<?php echo $row['o_no']; ?>" class="btn btn-warning btn-sm padd">Modify</a> &nbsp;
                                                        <a href="order-cancel1.php?o_no=<?php echo $row['o_no']; ?>" onclick="return confirmDelete();" class="btn btn-danger btn-sm">Cancel Order</a>
                                                    </td>
                                                <?php
                                                }
                                                ?>
