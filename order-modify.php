...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="staff.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="order-manage.php">Manage Orders</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            <form method="POST" action="ordermodifyprocess.php">
                                <div class="container">
                                    <fieldset>
                                        <br>
